...
const SideCard = () => {
	return (
		<div className="hidden md:block overflow-hidden shadow-lg border-b-4 bg-white mb-4 rounded-b-lg rounded-t border-ctapink w-full">
			<div className="px-6 py-4 mb-2 mt-4 mb-8">
				<div className="uppercase tracking-wide text-c2 mb-4">WordPress Services</div>
				<div
                ...
                <svg
					...
					<div className="pl-2">
					<Link href="/wordpress-services/task">
							<a>TASK</a>
						</Link>
					</div>
				</div>
                ...
                <svg
					...
					<div className="pl-2">
					<Link href="/wordpress-services/development">
							<a>WORK</a>
						</Link>
					</div>
				</div>
                ...
                <svg
					...
					<div className="pl-2">
					<Link href="/wordpress-services/seo">
							<a>DRED</a>
						</Link>
					</div>
				</div>
                ...
                <svg
					...
					<div className="pl-2">
					<Link href="/wordpress-services/increase-speed">
							<a>FAST</a>
						</Link>
					</div>
				</div>
				...
				<div>
                    ...
                    <svg
						...
						<div className="pl-2">
							<a href="https://possibleweb.spp.io/login" rel="noreferrer nofollow">
								Login
							</a>
						</div>
					</div>
