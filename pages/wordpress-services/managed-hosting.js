						...
						<div className="container flex flex-wrap overflow-hidden mx-auto">
							...
							<div className="w-full md:w-8/12 overflow-hidden my-4 md:my-12 bg-white border shadow rounded-lg mx-2 px-2">
								<div className="mx-4 mb-12">
									...
									<p className="text__body lead">
										White glove monthly service to host, support, and care for
										your WordPress website the way we would want our website
										cared for.
									</p>
									...
									<ul className="mt-3">
										<li className="text__body">
											<FontAwesomeIcon icon={faCheckCircle} /> PHP & Javascript
											Development
										</li>
										<li className="text__body">
											<FontAwesomeIcon icon={faCheckCircle} /> Database
											Architecture
										</li>
										<li className="text__body">
											<FontAwesomeIcon icon={faCheckCircle} /> Custom WordPress
											plugins
										</li>
										<li className="text__body">
											<FontAwesomeIcon icon={faCheckCircle} /> 3rd Party API
											Integrations
										</li>
									</ul>
									<div className="mt-4">
										<Button
											text="Start Care Service"
											link="https://possibleweb.spp.io/order/DYG3OV"
										/>
									</div>
								</div>
							</div>
